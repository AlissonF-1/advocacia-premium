...
export function Hero() {
  return (
    // MUDANÇA AQUI: Adicionei 'pt-32' para desgrudar do topo e mantive 'min-h-screen'
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary text-white pt-32 pb-20">
      ...
      <div 
        className="absolute inset-0 z-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1505664194779-8beaceb93744?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat"
      />
