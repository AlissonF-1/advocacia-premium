      ...
      <div className="container px-4 py-16 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-accent hover:text-primary transition-all duration-300"
              >
                <Instagram size={20} />
              </a>
              <a 
          ...
          <div className="space-y-6">
            ...
            {/* Mapa Incorporado (Atualizado para evitar erros de iframe) */}
            <div className="w-full h-32 bg-slate-800 rounded-lg overflow-hidden border border-slate-700 opacity-80 hover:opacity-100 transition-opacity">
               <iframe 
                 ...
                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.065830118861!2d-46.6534990237278!3d-23.566083961767692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0xd59f9431f2c9776a!2sAv.%20Paulista%2C%201000%20-%20Bela%20Vista%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2001310-100!5e0!3m2!1spt-BR!2sbr!4v1709665400000!5m2!1spt-BR!2sbr" 
                 width="100%" 
                 height="100%" 
                 style={{ border: 0 }} 
                 loading="lazy"
